      ...
      <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center  ">
        <div className="lg:w-1/2  text-center md:text-left">
          ...
          <span className="text-yellow-500 md:text-5xl "><Typewriter/> </span>
           Journey!</p>
          <p className="mt-8 text-xl text-gray-600">Welcome to the entrepreneurship community of Cloud Navigator where we ideate, iterate, and incubate the future innovations of the century!</p>
